...
Dans le but d'examiner l'influence conjointe de l'âge et du sexe sur la morphologie corporelle, nous avons testé si l'indice taille/poignet (ITP) varie de manière significative en fonction de la catégorie d'âge, du genre, ou de leur interaction. $$ITP = \frac{\text{Taille (cm)}}{\text{Tour de poignet(cm)}}$$ Effet de l'âge et du genre sur l'ITP Ce test visait à évaluer si l'indice ITP est influencé par l'âge, le genre ou leur interaction. Les résidus sont normalement distribués et les variances sont homogènes (test de Bartlett p = 0.12). L'effet de l'âge est significatif (p \< 0.001), mais pas celui du genre ni leur interaction. Cela suggère que l'ITP évolue avec l'âge mais ne diffère pas selon le sexe.
