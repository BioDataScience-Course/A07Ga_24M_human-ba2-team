...
L'analyse de l'indice taille/poignet (ITP) via une ANOVA à deux facteurs a ensuite mis en évidence une influence significative de l'âge sur cet indicateur morphologique. En revanche, ni le genre ni l'interaction entre l'âge et le genre n'ont pas eu d'impact notable. Ces résultats suggèrent que les variations de l'ITP sont principalement liées aux changements physiologiques associés au vieillissement, sans différence marquée entre les sexes. Une meilleure compréhension de ces changements pourrait améliorer l'évaluation des risques métaboliques associés au vieillissement.
...
Un test du chi² a également permis de mieux comprendre les relations entre l'âge et le risque cardiovasculaire. Il montre clairement que le risque augmente avec l'âge : les plus jeunes sont globalement moins exposés, tandis que les plus de 40 ans présentent un risque accru. Cette tendance met en lumière l'importance de la prévention dès l'entrée dans l'âge adulte.

Enfin, un autre test du chi² a révélé un lien significatif entre la consommation de sucre et le risque cardiovasculaire. Les personnes consommant régulièrement du sucre avaient davantage de risques, comparées à celles ayant une consommation plus modérée. En revanche, la qualité du sommeil ne semblait pas liée à ce risque, du moins dans cet échantillon.
...
biometry <- biometry %>.%
  smutate(.,sommeil_cat = case_when(sommeil < 7 ~ "Insuffisant",
