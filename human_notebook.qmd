...
-   **H₀ (hypothèse nulle)** : Le type d'ossature (indice ITP) est **indépendant** de la durée de sommeil.

-   **H₁ (hypothèse alternative)** : Le type d'ossature est **dépendant** de la durée de sommeil.
