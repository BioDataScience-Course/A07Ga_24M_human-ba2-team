...
$$IMG = 1.2 \times IMC + 0.23 \times \text{Âge} - 10.8 \times \text{Sexe} - 5.4$$ \# Calcul de la ou des variables reprenant l'indice sous forme numérique (et facteur)
...
Nous ne rejetons pas H0 au seuil de 5% Il n'existe pas une différence significative entre l'imc des hommes et celui des femmes au seuil alpha 5% (t = 0.33256, df = 141, p-value = 0.74)
