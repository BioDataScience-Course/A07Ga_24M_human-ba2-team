...
-Indépendance des observations:chaque ligne du dataset représente un individu.

-Les deux variables sont qualitatives: fast_food_cat est une variable catégorisée (Fréquent / Rare) et risque_ic est un facteur de risque catégorisé (Modéré / Élevé).

-Les effectifs attendus sont tous superieurs a 5.

```{r test_chi2_1 }
chisq.test(table_fast_food)$expected
