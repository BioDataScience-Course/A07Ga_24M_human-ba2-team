...
```{r}
chart(data = biometry, masse_corr ~ activite_physique) +
  geom_point()
```

**interprétation**
D'après le graphique, les personnes ayant une faible activité physique tendent à avoir une masse corporelle plus élevée.
